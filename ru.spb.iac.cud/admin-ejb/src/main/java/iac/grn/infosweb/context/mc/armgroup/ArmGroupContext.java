...
public class ArmGroupContext {
	...
	public ArmGroupContext(){
		auditItemsMap.put("groupName",new BaseTableItem("Название", "...", "groupName", 1));
		auditItemsMap.put("groupCode",new BaseTableItem("Код", "...", "groupCode", 2));
