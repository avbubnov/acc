...
public class ArmSubContext {
	...
	public ArmSubContext(){
		auditItemsMap.put("subsystemName",new BaseTableItem("Название", "...", "subsystemName", 1));
		auditItemsMap.put("subsystemCode",new BaseTableItem("Код", "...", "subsystemCode", 2));
		auditItemsMap.put("certAlias",new BaseTableItem("Алиас", "...", "certAlias", 3));
		auditItemsMap.put("armName",new BaseTableItem("ИС","...", "armName", "acIsBssT.name", "acIsBssTLong" , 4));
