...
public class STSOBOServiceClient {
	...
	*/
     ...
     */
		...
		System.out.println("STSServiceClient:sign_verify_soap_transform_2sign:01+");	  
		...
		//    System.out.println("dispatch:02");
		  ...
		  //  System.out.println("dispatch:03");
			...
			*/
			...
			String user_cert_file = "/Проекты/ЦУД разработка 4.0/сертификаты/etoken/bubnovNewEtoken.cer";
		  ...
		  // System.out.println("dispatch:05:"+DocumentUtil.asString(doc));
		  ...
		  // Преобразования над документом
			...
			System.out.println("dispatch:06:"+DocumentUtil.asString(doc));
		*/
		...
		// System.out.println("dispatch:07");
			
		 
			//	 System.out.println("dispatch:08");
			/*
			Node nodeToBeSigned=UsernameTokenSOAP;
			
			// используется при подготовка soap к отправке - замене неподписанного элемента подписанным
			 ...
			 System.out.println("dispatch:08_2:"+DocumentUtil.asString(newDoc));
			*/ 
...
*/
			 ...
			 try{
			   ...
			   //   System.out.println("cud_sts:02_1");	
			    
			       
			      /*
			      String root_cert_file = "/Проекты/ЦУД разработка 4.0/сертификаты/сервер/cudvm_der.cer";
			    ...
			    //  System.out.println("cud_sts:03:"+cert_hok);	
			     ...
			     // request.setUseKey(useKeyType);
   		       //   request.setKeyType(uri);
			    	 ...
			    	 System.out.println("cud_sts:04:"+e);	
			    }
...
try{
 ...
 Transformer transformer = TransformerFactory.newInstance().newTransformer();
    ...
    transformer.transform(new DOMSource(requestSource.getNode()), new StreamResult(System.out));
		    ...
		    //    System.out.println("dispatch:06");
		  ...
		  //  Pre-digested input: <wsse:UsernameToken wsu:Id="UsernameToken-1"><wsse:Username xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"></wsse:Username><wsse:Password xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"></wsse:Password></wsse:UsernameToken>
		   ...
		   // System.out.println("dispatch:011+:"+DocumentUtil.asString(newDoc));
		  //  System.out.println("dispatch:011+:"+DocumentUtil.asString(SecuritySOAP.getOwnerDocument()));
		...
		//	 System.out.println("dispatch_verify_1!");
		...
		//	 System.out.println("dispatch:011_4:"+signatureNode1.getNodeName());
		    ...
		    javax.xml.crypto.dsig.XMLSignature signature1 = fac.unmarshalXMLSignature(valContext1);
		    	...
		    	boolean result1 = signature1.validate(valContext1);
		    	 ...
		    	 System.out.println("dispatch:011_5:"+result1);
		    	 
				 
		    //	 System.out.println("dispatch:012:"+DocumentUtil.asString(doc));
		    ...
		    /*	 
		    	...
		    	*/ 
		    	// System.out.println("dispatch:013:"+DocumentUtil.asString(doc));
  ...
  //  sm.writeTo(System.out);
		  ...
		  //  System.out.println("dispatch:014");
		  ...
		  //signature
	    	 ...
	    	 if(signatureList_reply==null||signatureList_reply.getLength()==0){
	    		 System.out.println("TestServerCryptoSOAPHandler:handleMessage:02_1");
	    	 ...
	    	 if(x509CertificateList_reply!=null&&x509CertificateList_reply.getLength()>0){
	    		 System.out.println("TestServerCryptoSOAPHandler:handleMessage:02_2");
	        ...
	        // System.out.println("GostKeyHandler:handleRequestType:04:"+cert_reply);
	       ...
	       //  System.out.println("publicKey_reply:"+publicKey_reply);
	    	...
	    	// 2-я попытка - GOSTKeyValue
	    	 if(publicKey_reply==null){
		    	 ...
		    	 if(GOSTKeyList_reply==null||GOSTKeyList_reply.getLength()==0){
		    		 System.out.println("TestServerCryptoSOAPHandler:handleMessage:02_3");
		    	 ...
		    	 if(publicKeyList_reply==null||publicKeyList_reply.getLength()==0){
		    		 System.out.println("TestServerCryptoSOAPHandler:handleMessage:02_4");
		       ...
		       //  System.out.println("GostKeyHandler:handleRequestType:05_reply:"+base64PublKey_reply);
	        ...
	        // System.out.println("TestServerCryptoSOAPHandlerTransform:handleMessage:09_2:"+signatureNode1_reply.getNodeName());
			...
			valContext1_reply.setIdAttributeNS(soapBody_reply, "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd", "Id");
		       ...
		       javax.xml.crypto.dsig.XMLSignature signature1_reply = fac.unmarshalXMLSignature(valContext1_reply);
		    	...
		    	boolean result1_reply = signature1_reply.validate(valContext1_reply);
		    	 ...
		    	 System.out.println("STSServiceClient:sign_verify_soap_transform_2sign:70:validate:"+result1_reply);
               ...
               if(assertionList==null||assertionList.getLength()==0){
		    		 System.out.println("STSServiceClient:sign_verify_soap_transform_2sign:71");
			...
			System.out.println("STSServiceClient:sign_verify_soap_transform_2sign:error:"+e);	  
			
			System.out.println("STSServiceClient:sign_verify_soap_transform_2sign:error:02:"+
	                   e.getMessage().startsWith("ru.spb.iac.cud.exceptions.TokenExpired"));	
