...
public class STSOBOServiceClient {
	...
	final static Logger LOGGER = LoggerFactory
			.getLogger(STSOBOServiceClient.class);

	// используется только для set Applies To
	...
	public Document sign_verify_soap_transform_2sign(String onBehalfOfToken)
			throws Exception {
		 ...
		 * <dsig:SignedInfo> <dsig:Reference URI='#UsernameToken-1'
		 * xmlns:dsig='http://www.w3.org/2000/09/xmldsig#'> <dsig:Transforms
		 * xmlns:dsig='http://www.w3.org/2000/09/xmldsig#'> <dsig:Transform
		...
		/*
		 * [ru.CryptoPro.JCPxml.dsig.internal.dom.DOMReference]
		 * (http-0.0.0.0-80-1) Data class name:
		 * ru.CryptoPro.JCPxml.dsig.internal.dom.ApacheNodeSetData
		 * [ru.CryptoPro.JCPxml.dsig.internal.dom.ApacheTransform]
		 * (http-0.0.0.0-80-1) Created transform for algorithm:
		 * http://www.w3.org/2000/09/xmldsig#enveloped-signature
		 * [ru.CryptoPro.JCPxml.dsig.internal.dom.ApacheTransform]
		 * (http-0.0.0.0-80-1) Created transform for algorithm:
		 * http://www.w3.org/2000/09/xmldsig#enveloped-signature
		 * [ru.CryptoPro.JCPxml.dsig.internal.dom.ApacheTransform]
		 * (http-0.0.0.0-80-1) ApacheData = true
		 * [ru.CryptoPro.JCPxml.dsig.internal.dom.ApacheTransform]
		 * (http-0.0.0.0-80-1) ApacheData = true
		 * [ru.CryptoPro.JCPxml.dsig.internal.dom.ApacheCanonicalizer]
		 * (http-0.0.0.0-80-1) Created transform for algorithm:
		 ...
		 * [ru.CryptoPro.JCPxml.dsig.internal.dom.ApacheCanonicalizer]
		 * (http-0.0.0.0-80-1) ApacheData = true
		 * [ru.CryptoPro.JCPxml.dsig.internal.DigesterOutputStream]
		 * (http-0.0.0.0-80-1) Pre-digested input:
		 * [ru.CryptoPro.JCPxml.dsig.internal.DigesterOutputStream]
		 * (http-0.0.0.0-80-1) Pre-digested input:
		 */
		...
		try {
			 ...
			 * tlsCP = new TLSClientParameters(); final SSLSocketFactoryImpl
			...
			// wsu:Id="Header"
			// xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"><wsse:Security><wsse:UsernameToken
			// wsu:Id="UsernameToken-1"><wsse:Username
			// xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"/><wsse:Password
			// xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"/></wsse:UsernameToken></wsse:Security></env:Header><env:Body
			// wsu:Id="Body"
			// xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"/></env:Envelope>
			...
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"><dsig:SignedInfo><dsig:CanonicalizationMethod
			// Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"/><dsig:SignatureMethod
			// Algorithm="http://www.w3.org/2001/04/xmldsig-more#gostr34102001-gostr3411"
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"/><dsig:Reference
			// URI="#UsernameToken-1"
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"><dsig:Transforms
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"><dsig:Transform
			// Algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"/><dsig:Transform
			// Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"/></dsig:Transforms><dsig:DigestMethod
			// Algorithm="http://www.w3.org/2001/04/xmldsig-more#gostr3411"
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"/><dsig:DigestValue
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#">CjgZhMuDCKWfzsPLhwI6m72TuatCNeoaZP90a5etMEA=</dsig:DigestValue></dsig:Reference></dsig:SignedInfo><dsig:SignatureValue>pwGfBx3dXoaFC0hnnaCH4ZAfBuPI8aAYXZq6vQEdY8AUoHeiELjuuim7RaBp8thnkJ5LtMjNm714l8A+CIp7Cg==</dsig:SignatureValue><dsig:KeyInfo><dsig:KeyValue
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"><dsig:GOSTKeyValue
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#"><dsig:PublicKey
			// xmlns:dsig="http://www.w3.org/2000/09/xmldsig#">MGMwHAYGKoUDAgITMBIGByqFAwICJAAGByqFAwICHgEDQwAEQCunDBpRlzBS7ROt4BrFULCojjzROAkng89j1UOqRoIzpIdrgbHb5F5IxyxprcTPu2gDuCLhSvNCk5nEP5jdx80=</dsig:PublicKey></dsig:GOSTKeyValue></dsig:KeyValue></dsig:KeyInfo></dsig:Signature></wsse:UsernameToken></wsse:Security></env:Header><env:Body
			// wsu:Id="Body"
			// xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"><wst:RequestSecurityToken
			// xmlns:wst="http://docs.oasis-open.org/ws-sx/ws-trust/200512"><wst:RequestType>http://docs.oasis-open.org/ws-sx/ws-trust/200512/Issue</wst:RequestType><wst:TokenType>http://docs.oasis-open.org/wss/oasis-wss-saml-token-profile-1.1#SAMLV2.0</wst:TokenType></wst:RequestSecurityToken></env:Body></env:Envelope>
			...
			LOGGER.error("STSServiceClient:sign_verify_soap_transform_2sign:error:02:"
					+ e.getMessage().startsWith(
							"ru.spb.iac.cud.exceptions.TokenExpired"));
