...
public class TestClientCryptoSOAPHandler implements SOAPHandler<SOAPMessageContext>{
 ...
 public boolean handleMessage(SOAPMessageContext mc) {
	 ...
	 logger.info("TestClientCryptoSOAPHandler:handleMessage:01:"+mc.get(MessageContext.MESSAGE_OUTBOUND_PROPERTY));
	 ...
	 try{
	  ...
	  if (Boolean.TRUE.equals(mc.get(MessageContext.MESSAGE_OUTBOUND_PROPERTY))) {
	   ...
	   // logger.info("TestClientCryptoSOAPHandler:handleMessage:02:"+SecuritySOAP.getLocalName());
		...
		transformList.add(transformC14N);
		 ...
		 Reference ref1 = fac.newReference("#Header", fac.newDigestMethod("http://www.w3.org/2001/04/xmldsig-more#gostr3411", null) 
			...
			// logger.info("TestClientCryptoSOAPHandler:handleMessage:03");
	   ...
	   // logger.info("TestClientCryptoSOAPHandler:handleMessage:04");
	    
    }else{
    //ответ
    	
    	//logger.info("TestClientCryptoSOAPHandler:handleMessage:05");
    	 ...
    	 if(securityNode==null){
    		 logger.info("TestClientCryptoSOAPHandler:handleMessage:06");
    	 ...
    	 for (int i = 0; i<securityNodeChilds.getLength(); i++) {
    		...
    		// logger.info("TestClientCryptoSOAPHandler:handleMessage:07:"+securityNodeChilds.item(i).getLocalName());
    	...
    	// logger.info("TestClientCryptoSOAPHandler:handleMessage:08");
    	 
         //signature
    	 
    	 if(signatureNode1==null){
    		 logger.info("TestClientCryptoSOAPHandler:handleMessage:09");
    	        throw new Exception("This service requires <dsig:Signature>, which is missing!!!");
    	 }

    	
         
       //  logger.info("TestClientCryptoSOAPHandler:handleMessage:010:"+signatureNode1.getNodeName());
    	...
    	valContext1.setIdAttributeNS(body, "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd", "Id");
    	       ...
    	       javax.xml.crypto.dsig.XMLSignature signature1 = fac.unmarshalXMLSignature(valContext1);
    	    	...
    	    	boolean result1 = signature1.validate(valContext1);
    	    	 ...
    	    	 logger.info("TestClientCryptoSOAPHandler:handleMessage:010+:"+result1);
