...
public class GOSTXMLSignatureUtil {
	...
	public static Document sign(SignatureUtilTransferObject dto)
		...
		// loggerslf4j.info("sign:01:" + DocumentUtil.asString(doc));
	...
	public static boolean validate(Document signedDoc, Key publicKey)
		...
		// loggerslf4j.info("validate:02:"+coreValidity);
	...
	/**
	 * <p>
	 * Creates a {@code KeyValueType} that wraps the specified public key. This
	 * method supports DSA and RSA keys.
	 * </p>
	 * 
	 * @param key
	 *            the {@code PublicKey} that will be represented as a
	 *            {@code KeyValueType}.
	 * @return the constructed {@code KeyValueType} or {@code null} if the
	 *         specified key is neither a DSA nor a RSA key.
	 */
