...
public class ClUsrContext {
	...
	public ClUsrContext(){
		...
		auditItemsMap.put("position",new BaseTableItem("Должность", "...", "position", 4));
		auditItemsMap.put("phone",new BaseTableItem("Телефон", "...", "phone", 5));
		auditItemsMap.put("email",new BaseTableItem("E-mail", "...", "email", 6));
		*/
		auditItemsMap.put("signObject",new BaseTableItem("Код ИОГВ", "...", "signObject", 1));
		auditItemsMap.put("full",new BaseTableItem("Наименование", "...", "full", 2));
		auditItemsMap.put("fio",new BaseTableItem("ФИО", "...", "fio", 3));
