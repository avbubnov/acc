...
public class AppUserDepModifyContext {
	...
	public AppUserDepModifyContext(){
		...
		auditItemsMap.put("departament",new BaseTableItem("Подразделение", "...", "departament", "t1_NAME_DEPARTAMENT", 1, h1));
