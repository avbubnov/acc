...
public class CopyOfAuthManager {//implements AuthManagerLocal, AuthManagerRemote {

	@In EntityManager entityManager;
	
    public CopyOfAuthManager() {
    }

    public Map<String, ArrayList<String>[]> authComplete(String appCode, String login, String password) throws Exception{
    ...
    /*	ArrayList<String> raiList=new ArrayList<String>();
    	...
    	try{
    		...
    		Long idUser = createAuth(login,password);
       	  /*  Long idUser = ((java.math.BigDecimal) entityManager.createNativeQuery(
                 "select AU.ID_USER "+
                 "from "+
                 "AC_USERS au "+
                 "where AU.LOGIN=? "+
    		...
    		*/
            ...
            .setParameter(1, new Long(appCode))
		...
		/*}catch (NoResultException ex){
             System.out.println("AuthManager:getAuthConstraint:NoResultException");
             return null;*/
		}catch(Exception e){
    ...
    public ArrayList<String>[] access(String appCode,String pageCode, Long idUser) throws Exception{
     	return createResourceTree(appCode, null, idUser).get(pageCode);
    }
    private Map<String, ArrayList<String>[]> createResourceTree(String appCode, String pageCode, Long idUser) throws Exception{
    	...
    	List<Object[]> lo=
                ...
                .setParameter(1, new Long(appCode))
       	        .setParameter(2, idUser)
       	        .setParameter(3, (pageCode!=null?new Long(pageCode):new Long(1)))
       			.getResultList();
