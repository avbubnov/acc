...
public class ProcArchTokenSettingsManager {
	...
	//private static final String proc_atoken_settings_file=System.getProperty("jboss.server.config.url")+"proc_atoken_settings.properties";
	//private static final String proc_atoken_settings_file=System.getProperty("jboss.server.config.dir")+"/"+"proc_atoken_settings.properties";
	...
	public void init(){
		...
		try{
		   log.info("ConfLoadDataSettingsManager:init:01");
			...
			// String path = proc_atoken_settings_file;
