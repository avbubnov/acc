...
public class RolContext {
	...
	public RolContext(){
		auditItemsMap.put("roleTitle",new BaseTableItem("Название", "...", "roleTitle", 1));
		auditItemsMap.put("sign",new BaseTableItem("Код", "...", "sign", 2));
		auditItemsMap.put("roleDescription",new BaseTableItem("Описание", "...", "roleDescription", 3));
		auditItemsMap.put("armName",new BaseTableItem("ИС","...", "armName", "acApplication2.name", "acApplication" , 4));
	}
}
