...
@BypassInterceptors
@Startup*/
public class _Identity implements Serializable
{  
   ...
   public String login()
   {
	   ...
	   System.out.println("___________Identity:login:01");
      try
      {   
    	  System.out.println("___________Identity:login:02");
         if (isLoggedIn())
         {
        	 System.out.println("___________Identity:login:03");
            ...
            {
            	System.out.println("___________Identity:login:04");
               if (Events.exists()) Events.instance().raiseEvent(EVENT_LOGIN_SUCCESSFUL);
               return "loggedIn";            
            }            
            
            System.out.println("___________Identity:login:05");
            if (Events.exists()) Events.instance().raiseEvent(EVENT_ALREADY_LOGGED_IN);
            return "loggedIn";           
         }
         
         System.out.println("___________Identity:login:06");
         authenticate();
         
         System.out.println("___________Identity:login:07");
         if (!isLoggedIn())
         {
        	 System.out.println("___________Identity:login:08");
      ...
      {
    	  System.out.println("___________Identity:login:09");
      ...
      System.out.println("___________Identity:login:010");
   ...
   public synchronized void authenticate() 
      throws LoginException
   {
	   System.out.println("___________Identity:authenticate:01:"+credentials.isInvalid());
      // If we're already authenticated, then don't authenticate again
      if (!isLoggedIn() && !credentials.isInvalid())
      {
    	  System.out.println("___________Identity:authenticate:02");
         principal = null;
         subject = new Subject();
         authenticate( getLoginContext() );
         System.out.println("___________Identity:authenticate:03");
      }      
      System.out.println("___________Identity:authenticate:04");
   }
