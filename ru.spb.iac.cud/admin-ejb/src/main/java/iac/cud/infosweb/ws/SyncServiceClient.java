...
public class SyncServiceClient {
	...
	public static void main(String[] args) {
		 ...
		 try{
			 SyncServiceClient ssc = new SyncServiceClient();
	...
	public void sync_functions() throws Exception{
    	...
    	/*func.setIdFunction(ResourcesMap.USER.getCode()+":"+ActionsMap.CREATE.getCode());
    	func.setName("Создание пользователя");
    	func.setDescription("Создание пользователя");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.USER.getCode()+":"+ActionsMap.UPDATE.getCode());
    	func.setName("Редактирование пользователя");
    	func.setDescription("Редактирование пользователя");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.USER.getCode()+":"+ActionsMap.UPDATE_ROLE.getCode());
    	func.setName("Редактирование ролей пользователя");
    	func.setDescription("Редактирование ролей пользователя");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.USER.getCode()+":"+ActionsMap.UPDATE_GROUP.getCode());
    	func.setName("Редактирование групп пользователя");
    	func.setDescription("Редактирование групп пользователя");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.USER.getCode()+":"+ActionsMap.DELETE.getCode());
    	...
    	//роли
    	func = new Function();
    	func.setIdFunction(ResourcesMap.ROLE.getCode()+":"+ActionsMap.CREATE.getCode());
    	func.setName("Создание роли");
    	func.setDescription("Создание роли");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.ROLE.getCode()+":"+ActionsMap.UPDATE.getCode());
    	func.setName("Редактирование роли");
    	func.setDescription("Редактирование роли");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.ROLE.getCode()+":"+ActionsMap.DELETE.getCode());
    	...
    	func = new Function();
    	func.setIdFunction(ResourcesMap.UGROUP.getCode()+":"+ActionsMap.CREATE.getCode());
    	func.setName("Создание группы пользователей");
    	func.setDescription("Создание группы пользователей");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.UGROUP.getCode()+":"+ActionsMap.UPDATE.getCode());
    	func.setName("Редактирование группы пользователей");
    	func.setDescription("Редактирование группы пользователей");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.UGROUP.getCode()+":"+ActionsMap.UPDATE_ROLE.getCode());
    	func.setName("Редактирование ролей группы пользователей");
    	func.setDescription("Редактирование ролей группы пользователей");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.UGROUP.getCode()+":"+ActionsMap.UPDATE_USER.getCode());
    	func.setName("Редактирование пользователей группы пользователей");
    	func.setDescription("Редактирование пользователей группы пользователей!");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.UGROUP.getCode()+":"+ActionsMap.DELETE.getCode());
    	...
    	functions.add(func);
    	 ...
    	 //ис
    	func = new Function();
    	func.setIdFunction(ResourcesMap.IS.getCode()+":"+ActionsMap.CREATE.getCode());
    	func.setName("Создание ИС");
    	func.setDescription("Создание ИС");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.IS.getCode()+":"+ActionsMap.UPDATE.getCode());
    	func.setName("Редактирование ИС");
    	func.setDescription("Редактирование ИС");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.IS.getCode()+":"+ActionsMap.DELETE.getCode());
    	...
    	functions.add(func);
    	 ...
    	 //ресурсы
    	func = new Function();
    	func.setIdFunction(ResourcesMap.RES.getCode()+":"+ActionsMap.CREATE.getCode());
    	func.setName("Создание ресурса");
    	func.setDescription("Создание ресурса");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.RES.getCode()+":"+ActionsMap.UPDATE.getCode());
    	func.setName("Редактирование ресурса");
    	func.setDescription("Редактирование ресурса");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.RES.getCode()+":"+ActionsMap.DELETE.getCode());
    	...
    	func = new Function();
    	func.setIdFunction(ResourcesMap.CONF_PARAM.getCode()+":"+ActionsMap.UPDATE.getCode());
    	...
    	func = new Function();
    	func.setIdFunction(ResourcesMap.AUDIT_USER.getCode()+":"+ActionsMap.START.getCode());
    	func.setName("Запуск архивирования аудита действий пользователя");
    	func.setDescription("Запуск архивирования аудита действий пользователя");
    	functions.add(func);
    
    	 //журнал вызовов сервисов
    	func = new Function();
    	func.setIdFunction(ResourcesMap.AUDIT_SYS.getCode()+":"+ActionsMap.START.getCode());
    	...
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_AUDIT_USER.getCode()+":"+ActionsMap.START.getCode());
    	func.setName("Запуск процесса архивирования аудита действий пользователя");
    	func.setDescription("Запуск процесса архивирования аудита действий пользователя");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_AUDIT_USER.getCode()+":"+ActionsMap.PAUSE.getCode());
    	func.setName("Пауза процесса архивирования аудита действий пользователя");
    	func.setDescription("Пауза процесса архивирования аудита действий пользователя");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_AUDIT_USER.getCode()+":"+ActionsMap.STOP.getCode());
    	func.setName("Останов процесса архивирования аудита действий пользователя");
    	func.setDescription("Останов процесса архивирования аудита действий пользователя");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_AUDIT_USER.getCode()+":"+ActionsMap.SET_PARAM.getCode());
    	func.setName("Параметры процесса архивирования аудита действий пользователя");
    	func.setDescription("Параметры процесса архивирования аудита действий пользователя");
    	functions.add(func);
    	
    	 //процесс архивирование аудита вызова сервисов
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_AUDIT_SYS.getCode()+":"+ActionsMap.START.getCode());
    	...
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_AUDIT_SYS.getCode()+":"+ActionsMap.PAUSE.getCode());
    	...
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_AUDIT_SYS.getCode()+":"+ActionsMap.STOP.getCode());
    	func.setName("Останов процесса архивирования аудита вызова сервисов");
    	func.setDescription("Останов процесса архивирования аудита вызова сервисов");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_AUDIT_SYS.getCode()+":"+ActionsMap.SET_PARAM.getCode());
    	func.setName("Параметры процесса архивирования аудита вызова сервисов");
    	func.setDescription("Параметры процесса архивирования аудита вызова сервисов");
    	functions.add(func);
    	
    	 //процесс архивирование токенов
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_TOKEN.getCode()+":"+ActionsMap.START.getCode());
    	func.setName("Запуск процесса архивирования токенов");
    	func.setDescription("Запуск процесса архивирования токенов");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_TOKEN.getCode()+":"+ActionsMap.PAUSE.getCode());
    	func.setName("Пауза процесса архивирования токенов");
    	func.setDescription("Пауза процесса архивирования токенов");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_TOKEN.getCode()+":"+ActionsMap.STOP.getCode());
    	func.setName("Останов процесса архивирования токенов");
    	func.setDescription("Останов процесса архивирования токенов");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_ARCH_TOKEN.getCode()+":"+ActionsMap.SET_PARAM.getCode());
    	...
    	*/
    	...
    	functions.add(func);
    	 ...
    	 //ППС не активных
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_BIND_NOACT.getCode()+":"+ActionsMap.START.getCode());
    	func.setName("Запуск ППС не активных УЗП К ОГК ИОГВ");
    	func.setDescription("Запуск ППС не активных  УЗП К ОГК ИОГВ");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_BIND_NOACT.getCode()+":"+ActionsMap.PAUSE.getCode());
    	func.setName("Пауза ППС не активных  УЗП К ОГК ИОГВ");
    	func.setDescription("Пауза ППС не активных  УЗП К ОГК ИОГВ");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_BIND_NOACT.getCode()+":"+ActionsMap.STOP.getCode());
    	func.setName("Останов ППС не активных  УЗП К ОГК ИОГВ");
    	func.setDescription("Останов ППС не активных  УЗП К ОГК ИОГВ");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.PROC_BIND_NOACT.getCode()+":"+ActionsMap.SET_PARAM.getCode());
    	...
    	func = new Function();
    	func.setIdFunction(ResourcesMap.BINDING_IOGV.getCode()+":"+ActionsMap.CREATE.getCode());
    	func.setName("Создание привязки УЗП к ОГК ИОГВ");
    	func.setDescription("Создание привязки УЗП к ОГК ИОГВ");
    	functions.add(func);
    	
    	func = new Function();
    	func.setIdFunction(ResourcesMap.BINDING_IOGV.getCode()+":"+ActionsMap.UPDATE.getCode());
    	...
    	*/
    	...
    	func = new Function();
    	func.setCode(ResourcesMap.ROLE.getCode()+":"+ActionsMap.UPDATE_USER.getCode());
    	func.setName("Редактирование пользователей роли");
    	func.setDescription("Редактирование пользователей роли");
    	functions.add(func);
    	
    	func = new Function();
    	func.setCode(ResourcesMap.ROLE.getCode()+":"+ActionsMap.UPDATE_GROUP.getCode());
	...
	private SyncServices getPort(String endpointURI) throws MalformedURLException   {
		  
		if(this.syncServices==null){
		   QName serviceName = new QName("http://sync.services.cud.iac/", "SyncServicesImplService");
		   URL wsdlURL = new URL(endpointURI);

		   Service service = Service.create(wsdlURL, serviceName);
		
		   QName portName = new QName("http://sync.services.cud.iac/", "SyncServicesImplPort");
