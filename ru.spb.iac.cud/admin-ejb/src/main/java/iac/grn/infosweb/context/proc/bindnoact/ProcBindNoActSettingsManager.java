...
public class ProcBindNoActSettingsManager {
	...
	public void save(){
		try{
		  ...
		  // log.info("procBindNoActSettingsManager:save:ParamActualData:"+beanSettings.getParamActualData());
...
/*	@Factory
	public ConfLoadDataSettingsItem getCLDSBeanView(){
		...
		// String path = FacesContext.getCurrentInstance().getExternalContext().getInitParameter("conf_loaddata_settings");
		 ...
		 log.info("procBindNoActSettingsManager:getCLDSBeanView:path:"+path);
