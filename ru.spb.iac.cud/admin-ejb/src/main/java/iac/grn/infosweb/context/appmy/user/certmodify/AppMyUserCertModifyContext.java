...
public class AppMyUserCertModifyContext {
	...
	public AppMyUserCertModifyContext(){
		
		
		HeaderTableItem h1=null, h2=null, h3=null, h4=null, h5=null, h6=null;
		
		
		headerItemsList.add(h1=new HeaderTableItem("Содержание:сертификат", "h1"));
		headerItemsList.add(h6=new HeaderTableItem("Содержание:общее", "h6"));
		...
		auditItemsMap.put("certNum",new BaseTableItem("Номер", "...", "certNum", "-", 1, h1));
		auditItemsMap.put("certDate",new BaseTableItem("Годен до", "...", "certDate", "-", 2, h1));
		auditItemsMap.put("certOrgName",new BaseTableItem("Организация", "...", "certOrgName", "-", 3, h1));
		auditItemsMap.put("certDepName",new BaseTableItem("Подразделение", "...", "certDepName", "-", 4, h1));
		auditItemsMap.put("certUserFio",new BaseTableItem("ФИО", "...", "certUserFio", "-", 5, h1));
		...
		auditItemsMap.put("modeExecValue",new BaseTableItem("Режим выполнения", "...", "modeExecValue", "...", 1, h6));
