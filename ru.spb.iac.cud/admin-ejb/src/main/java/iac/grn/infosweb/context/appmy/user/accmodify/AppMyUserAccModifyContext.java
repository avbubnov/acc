...
public class AppMyUserAccModifyContext {
	...
	public AppMyUserAccModifyContext(){
		...
		auditItemsMap.put("login",new BaseTableItem("Логин", "...", "login", "t1_login_USER", 1, h1));
		auditItemsMap.put("password",new BaseTableItem("Пароль", "...", "password", "t1_password_USER", 2, h1));
		auditItemsMap.put("certificate",new BaseTableItem("Сертификат", "...", "certificate", "t1_CERTIFICATE_USER", 3, h1));
